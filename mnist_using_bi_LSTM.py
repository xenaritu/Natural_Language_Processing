...
def get_mnist(limit=None):
  if not os.path.exists(os.path.join(dname,'large_files/mnist/train.csv')):
  ...
  if not os.path.exists(os.path.join(dname,'large_files/mnist/train.csv')):
    ...
    print("and place it in the large_files mnist folder.")

  print("Reading in and transforming data...")
  df = pd.read_csv(os.path.join(dname,'large_files/mnist/train.csv'))
  data = df.values
